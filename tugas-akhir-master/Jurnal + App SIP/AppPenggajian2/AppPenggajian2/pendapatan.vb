...
Public Class pendapatan
    ...
    End Sub
    Sub tampil()
        da = New OleDbDataAdapter("select * from pendapatan", conn)
        ds = New DataSet
        da.Fill(ds)
    ...
    End Sub
    Sub carikode()
        cmd = New OleDbCommand("SELECT * FROM pendapatan where id_pendapatan='" & TextBox1.Text & "'", conn)
    ...
    Private Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If Not dr.HasRows Then
                Dim simpan As String = "INSERT INTO pendapatan VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "')"
                cmd = New OleDbCommand(simpan, conn)
                cmd.ExecuteNonQuery()
            Else
                Dim edit As String = "UPDATE pendapatan SET nama_pendapatan = '" & TextBox2.Text & "' WHERE id_pendapatan = '" & TextBox1.Text & "'"
    ...
    Private Sub Button2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button2.Click
        ...
        If MessageBox.Show("Yakin Ingin Dihapus ? ", "PERINGATAN", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Dim hapus As String = "DELETE * from pendapatan WHERE id_pendapatan = '" & TextBox1.Text & "'"
    ...
    Private Sub TextBox5_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles TextBox5.TextChanged
        da = New OleDbDataAdapter("select * from pendapatan where nama_pendapatan like'%" & TextBox5.Text & "%'", conn)
        ds = New DataSet
        da.Fill(ds)
        dgv.DataSource = ds.Tables(0)
        dgv.ReadOnly = True
