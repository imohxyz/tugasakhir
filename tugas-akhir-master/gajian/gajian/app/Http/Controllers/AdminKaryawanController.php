<?php namespace App\Http\Controllers;
	...
	class AdminKaryawanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Nomor Telepon","name"=>"telepon"];
			$this->col[] = ["label"=>"Jabatan","name"=>"jabatan_id","join"=>"jabatan,jabatan"];
			$this->col[] = ["label"=>"Divisi","name"=>"divisi_id","join"=>"divisi,divisi"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nomor Induk Karyawan','name'=>'nik','type'=>'text','validation'=>'required|min:1|max:10','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Nomor Telepon','name'=>'telepon','type'=>'text','validation'=>'required|min:1|max:15|double','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nama Jabatan','name'=>'jabatan_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'jabatan,id'];
			$this->form[] = ['label'=>'Nama Divisi','name'=>'divisi_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'divisi,id'];
			...
			//$this->form[] = ["label"=>"Divisi Id","name"=>"divisi_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"divisi,id"];
			# OLD END FORM
