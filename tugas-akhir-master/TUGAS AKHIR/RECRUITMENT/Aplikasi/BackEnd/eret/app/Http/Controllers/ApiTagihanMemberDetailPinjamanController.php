<?php namespace App\Http\Controllers;
		...
		class ApiTagihanMemberDetailPinjamanController extends \crocodicstudio\crudbooster\controllers\ApiController {
		    private $member_id;
            private $kategori_id;
		    function __construct() {    
				$this->table       = "kategori_tagihan_member";        
				$this->permalink   = "tagihan_member_detail_pinjaman";    
