<?php namespace App\Http\Controllers;
	...
	class AdminPinjamanMember30Controller extends \crocodicstudio\crudbooster\controllers\CBController {
        ...
        public function getTolak($id) {
           date_default_timezone_set('Asia/Jakarta');
            ...
            CRUDBooster::redirect(CRUDBooster::mainpath(),'Pinjaman Berhasil Ditolak','success');
